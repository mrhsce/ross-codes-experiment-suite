...
mpirun --map-by core -np $num ../../../build/src/network-workloads/model-net-synthetic-dragonfly-all --synch=3 --warm_up_time=30000 --traffic=2 --payload_sz=256 --lp-io-dir="output" --lp-io-use-suffix=1  --load=0.1 --num_messages=10000 --extramem=300000  -- ./modelnet-test-dragonfly-dally.conf
